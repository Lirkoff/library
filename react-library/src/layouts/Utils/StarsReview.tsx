        ...
        <div>
            {Array.from({length: fullStars}, (_, i) =>
                <svg key={i}
                     ...
                     style={{color: "gold"}} className="bi bi-star-fill" viewBox="0 0 16 16">
                    <path
            ...
            {Array.from({length: halfStars}, (_, i) =>
                <svg key={i}
                     xmlns="http://www.w3.org/2000/svg" width={props.size} height={props.size} fill="currentColor"
                     style={{color: "gold"}} className="bi bi-star-half" viewBox="0 0 16 16">
                    <path
            ...
            {Array.from({length: emptyStars}, (_, i) =>
                <svg key={i}
                     xmlns="http://www.w3.org/2000/svg" width={props.size} height={props.size} fill="currentColor"
                     style={{color: "gold"}} className="bi bi-star"
                     viewBox="0 0 16 16">
                    <path
